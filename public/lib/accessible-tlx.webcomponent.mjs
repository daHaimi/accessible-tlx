...
var code$2 = "de_DE";
var description$2 = "German - Germany";
var translations$2 = {
	MentalDemand: {
		title: "Mentaler Anspruch",
		description: "Wie hoch war der mentale Anspruch der Aufgabe?"
	},
	PhysicalDemand: {
		title: "Physischer Anspruch",
		description: "Wie hoch war der physische Anspruch der Aufgabe?"
	},
	TemporalDemand: {
		title: "Zeitlicher Anspruch",
		description: "Wie eilig oder gehetzt war die Aufgabe?"
	},
	Performance: {
		title: "Erfolg",
		description: "Wie erfolgreich waren Sie bei der Erfüllung der Aufgabe?"
	},
	Effort: {
		title: "Aufwand",
		description: "Wie sehr mussten Sie sich anstrengen um die Aufgabe zu erfüllen?"
	},
	Frustration: {
		title: "Frustration",
		description: "Wie verunsichert, entmutigt, irritiert, gestresst und genervt waren Sie?"
	},
	errors: {
		"fields missing": "Alle Felder müssen gefüllt werden."
	}
};
var de_DE = {
	code: code$2,
...
var code$1 = "de_LS";
var description$1 = "German - Leichte Sprache";
var translations$1 = {
	MentalDemand: {
		title: "Mentaler Anspruch",
		description: "Wie anstrengend war das Denken bei der Aufgabe?"
	},
	PhysicalDemand: {
		title: "Physischer Anspruch",
		description: "Wie körperlich anstrengend war die Aufgabe?"
	},
	TemporalDemand: {
		title: "Zeitlicher Anspruch",
		description: "Wie stark musstest du dich bei der Aufgabe beeilen?"
	},
	Performance: {
		title: "Erfolg",
		description: "Wie erfolgreich hast du die Aufgabe gelöst?"
	},
	Effort: {
		title: "Aufwand",
		description: "Wie anstrengend war es die Aufgabe zu erfüllen?"
	},
	Frustration: {
		title: "Frustration",
		description: "Wie unsicher, verwirrt, gestresst und genervt warst du?"
	},
	errors: {
		"fields missing": "Alle Felder müssen gefüllt werden."
	},
	ForgetProblems: {
		...
		description: "In der Simulation konnte ich meine echten Probleme vergessen"
	},
	AnotherWorld: {
		title: "Andere Welt",
		description: "In der Simulation fühlte ich mich wie in einer anderen Welt"
	},
	ForgetAround: {
		title: "Die Welt vergessen",
		description: "Während der Simulation habe ich de Welt um mich total vergessen"
	},
	Experience: {
		title: "Situation erleben",
		description: "In der Simulation hatte ich das Gefühl die Situation wirklich zu erleben"
	}
};
var de_LS = {
	code: code$1,
...
var code = "en_US";
var description = "English - United States";
var translations = {
	MentalDemand: {
		title: "Mental Demand",
	...
	errors: {
		"fields missing": "All fields must be filled in."
	}
};
var en_US = {
	code: code,
...
let AccessibleTlx = _decorate([n$1('accessible-tlx')], function (_initialize, _LitElement) {
  class AccessibleTlx extends _LitElement {
    constructor() {
      super(); // Language valid?
  ...
  return {
    ...
    d: [{
      ...
      value() {
        return AccessibleTlx.DEFAULT_LOCALE;
      }
      ...
      value: function firstUpdated(_changedProperties) {
        _get(_getPrototypeOf(AccessibleTlx.prototype), "firstUpdated", this).call(this, _changedProperties);
      ...
      kind: "method",
      key: "_renderRow",
      value: function _renderRow(rowName, reverse) {
        const x = [];
